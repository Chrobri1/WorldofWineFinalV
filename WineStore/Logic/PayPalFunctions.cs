...
public class NVPAPICaller
{
    ...
    public string APIUsername = "chrobri1-facilitator_api1.gmail.com";
    private string APIPassword = "APYVGV5RAP6BDFZH";
    private string APISignature = "AFcWxV21C7fd0v3bYYYRCpSSRl31AhC-J.aqVcyS7DXMfHTfoDZXQi9V";
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
        ...
        encoder["BRANDNAME"] = "Wine Store Application";
        ...
        using (WineStore.Logic.ShoppingCartActions myCartOrders = new WineStore.Logic.ShoppingCartActions())
        {
